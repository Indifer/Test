    ...
    public class UserToken : IDisposable
    {
        ...
        private void BeginReceive()
        {
            ...
            try
            {
                ...
                if (_socket != null)
                {
                    _socket.BeginReceive(buffer, 0, buffer.Length, SocketFlags.None, RecevieCallBack, null);
                }
        ...
        private void RecevieCallBack(IAsyncResult result)
        {
            ...
            if (_socket != null && result != null && result.IsCompleted)
            {
                try
                {
                ...
                lock (bufferList)
                {
                    ...
                    {
                        ReceiveSuccessAction(bufferList.Count);
                    }
                    ...
                    try
                    {
                        ...
                        if (_socket != null && bufferList.Count > 0)
                        {
                            _socket.BeginReceive(buffer, 0, buffer.Length, SocketFlags.None, RecevieCallBack, null);
                        }
                        else
